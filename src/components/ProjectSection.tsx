...
function ProjectSection() {
    return (<div className={styles.container} id="projects">
        ...
        <div className={styles.contentContainer}>
            ...
            imageLink={'/images/streamvibe.png'} techStacks={streamvibeTechStacks} sourceLink={'https://github.com/sajidMunir04/stream-vibe'} demoLink={'https://streamvibes.netlify.app'}/>
        </div>
    </div>);
}
