...
import { jobhuntlyTechStacks, littleLearnersTechStacks, luminaeTechStacks, questeriaTechStacks, skillbridgeTechStacks, streamvibeTechStacks, thecoachTechStacks, yourBankTechStacks } from "../lib/ProjectsTechStacks";
